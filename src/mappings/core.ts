...
export function handleSwap(event: Swap): void {
  ...
  let taxiswapDayData = updateUniswapDayData(event)
...
function postProcess(pair: Pair | null, token0: Token| null, token1: Token | null, taxiswap: UniswapFactory | null): void {
